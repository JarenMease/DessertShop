...
def test_Cookie():
    ...
    assert new_Cookie().price == 12
    assert new_Cookie().unit == 12.99
...
def test_IceCream():
    ...
    assert new_IceCream().price == 3
    assert new_IceCream().unit == 1.99
...
def test_Sundae():
    ...
    assert sundae.unit == float
    assert sundae.price == int
    ...
    assert new_Sundae().price == 3
    assert new_Sundae().unit == 1.59
